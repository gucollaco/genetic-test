def pdf_to_csv(filename, separator, threshold):
    ...
    class CsvConverter(TextConverter):
        ...
        def line_creator(self, line):
            ...
            result = [line[keys[0]].decode('utf-8')]
            for i in range(1, len(keys)):
                ...
                result.append(line[keys[i]].decode('utf-8'))
...
if __name__ == '__main__':
    ...
    threshold = 1.5
    print(pdf_to_csv('catalogo/Laboratório de Sistemas Computacionais - Arquitetura e Organização de Computadores.pdf', separator, threshold))